                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    @foreach (($viewsList ?? []) as $viewItem)
                                        <option value="{{ $viewItem->id }}" @selected(old('view_id_action', $operation->view_id_action) == $viewItem->id)>
                                            {{ $viewItem->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            @error('view_id_action') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                        </div>
