...
@section('content')
    <div x-data="{}">
                ...
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                             <th style="background-color: #63B7EC; color: #FFFFFF;" class="px-3 py-3 text-center sm:px-6 sticky-left-header">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        @foreach ($rowOperations as $operation)
                                            @php
                                                ...
                                                $actionUrl = $resolveActionUrl($action, $profile, $operation);
        ...
        <x-ui.modal x-data="{ open: false }" @open-profile-modal.window="open = true"
            @close-profile-modal.window="open = false" :isOpen="false" :showCloseButton="false" class="max-w-3xl">
            <div class="p-6 sm:p-8">
                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Registrar perfil</h3>
                            <p class="mt-1 text-sm text-gray-500">Ingresa la informacion del perfil.</p>
                        </div>
                    </div>
