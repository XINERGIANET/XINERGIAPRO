    ...
    <div class="space-y-6">
        <x-common.component-card title="Ubicaciones" desc="Administra los puntos de trabajo para armados por sucursal o a nivel general.">
            <div class="mb-5 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <form method="GET" action="{{ route('workshop.assembly-locations.index') }}" class="grid flex-1 grid-cols-1 gap-3 md:grid-cols-[minmax(0,1fr)_auto_auto]">
                    <div class="relative">
                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="inline-flex items-center gap-2">
                                        <button type="button" class="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-amber-200 bg-amber-50 text-amber-600 transition hover:bg-amber-100" @click="$dispatch('open-edit-location-{{ $location->id }}')">
                                        ...
                                        <x-ui.modal x-data="{ open: false }" x-on:open-edit-location-{{ $location->id }}.window="open = true" :isOpen="false" :showCloseButton="false" class="max-w-2xl">
