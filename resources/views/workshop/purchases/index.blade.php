    ...
    <x-common.component-card title="Registro de compras" desc="Consulta compras de taller y exporta registros mensuales.">
        ...
        <form method="GET" action="{{ route('workshop.purchases.index') }}" class="mb-5 flex flex-wrap items-center gap-3 rounded-2xl border border-gray-100 bg-white p-3 shadow-sm dark:border-gray-800 dark:bg-white/[0.02]">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <select name="supplier_id" class="h-11 rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <select name="document_kind" class="h-11 rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <select name="branch_id" class="h-11 rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium text-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500" @disabled(!$isAdmin)>
        ...
        <div class="overflow-x-auto overflow-y-hidden mt-4 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <table class="w-full min-w-[1100px]">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="9" class="px-4 py-4 text-sm text-gray-500 text-center">Sin compras para el filtro.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        ...
        <div class="mt-4 flex flex-col items-center justify-between gap-4 p-4 md:flex-row">
            <div class="text-[14px] font-semibold text-gray-600">
                Mostrando {{ $records->firstItem() ?? 0 }} - {{ $records->lastItem() ?? 0 }} de {{ $records->total() }}
            </div>
