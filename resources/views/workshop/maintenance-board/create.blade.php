    ...
    <div x-data="Object.assign(typeof formAutocompleteHelpers === 'function' ? formAutocompleteHelpers() : {}, {
        ...
        <x-common.component-card>
            ...
            <form method="POST" action="{{ $editingOrder ? route('workshop.maintenance-board.update', $editingOrder) : route('workshop.maintenance-board.store') }}" enctype="multipart/form-data" data-turbo="false" @submit="syncSignature()" class="grid grid-cols-1 gap-3 md:grid-cols-3">
                ...
                @if(request('advance_corrective'))
                    <input type="hidden" name="advance_corrective_phase" value="1">
                @endif
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-4 md:col-span-3" x-show="serviceType !== 'correctivo' || '{{ request('advance_corrective') ? 1 : 0 }}' === '1'" x-cloak @if(($serviceType ?? 'preventivo') === 'correctivo' && !request('advance_corrective')) style="display: none;" @endif>
                ...
                <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-4 md:col-span-3" x-show="serviceType !== 'correctivo' || '{{ request('advance_corrective') ? 1 : 0 }}' === '1'" x-cloak @if(($serviceType ?? 'preventivo') === 'correctivo' && !request('advance_corrective')) style="display: none;" @endif>
                    <div class="mb-3 flex items-center justify-between">
                    ...
                    <div class="mt-3 border-t border-gray-200 pt-2 text-right text-sm font-semibold text-gray-800" x-show="serviceType !== 'correctivo' || '{{ request('advance_corrective') ? 1 : 0 }}' === '1'" x-cloak>
