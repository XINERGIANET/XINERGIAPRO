            ...
            <table class="w-full min-w-[720px]">
                <thead>
                    <tr>
                        ...
                        <th style="background-color:#63B7EC" class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-white">Orden</th>
                        ...
                        <th style="background-color:#63B7EC" class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-white">Origen</th>
                        ...
                        <tr class="border-t border-gray-100 dark:border-gray-800">
                            ...
                            <td class="px-4 py-3 text-sm">
                                ...
                                <div class="flex flex-wrap gap-1.5">
                                    <button type="button" @click="$dispatch('open-edit-vehicle-type-modal', {{ $type->id }})" class="rounded-lg bg-amber-600 px-3 py-1.5 text-xs font-medium text-white">Editar</button>
                                    <form method="POST" action="{{ route('workshop.vehicle-types.destroy', $type) }}" onsubmit="return confirm('Eliminar tipo de vehiculo?')">
                                        @csrf
                                        @method('DELETE')
