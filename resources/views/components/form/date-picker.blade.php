            ...
            this.$nextTick(() => {
                this.flatpickrInstance = flatpickr(this.$refs.dateInput, {
                    ...
                    locale: (() => {
                        ...
                        if (localeKey === 'es' && window.flatpickr?.l10ns?.es) {
                            return window.flatpickr.l10ns.es;
                        }
                        if (localeKey === 'es') {
                            return {
                                weekdays: {
...
>
    ...
    <div class="relative custom-datepicker">
        <input
            ...
            class="{{ $inputClass ?? $dateInputDefaultClass }}"
            autocomplete="off"
        />
        <span class="custom-datepicker__icon pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400">
...
@once
    @push('styles')
        <style>
            .datepicker-compact .flatpickr-calendar { font-size: 12px; }
            .datepicker-compact .flatpickr-months .flatpickr-month,
            .datepicker-compact .flatpickr-current-month { height: 38px; }
            .datepicker-compact .flatpickr-weekday,
            .datepicker-compact .flatpickr-day { max-width: 32px; height: 32px; line-height: 32px; }
            .datepicker-compact .flatpickr-time input,
            .datepicker-compact .numInputWrapper span { font-size: 12px; }
            /* Flatpickr móvil usa input datetime-local: icono nativo + SVG del componente = doble icono */
            .custom-datepicker input.flatpickr-mobile::-webkit-calendar-picker-indicator {
                opacity: 0;
                display: none;
            ...
            .custom-datepicker input.flatpickr-mobile::-webkit-inner-spin-button {
                display: none;
                -webkit-appearance: none;
            }
        </style>
