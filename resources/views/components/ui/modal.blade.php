...
@endif
    <div
        ...
        <div
            @click.stop
            class="relative flex w-full flex-col overflow-hidden rounded-3xl bg-[#F4F6FA] dark:bg-gray-900 {{ $attributes->get('class') }}"
            style="max-height: min(calc(100vh - 1.5rem), calc(100dvh - 1.5rem)); width: 100%; margin: 0 auto;"
