                ...
                <div class="grid gap-4 md:grid-cols-2">
                    @forelse (($productTypes ?? collect()) as $productType)
                        @php
                            ...
                            $cardClasses = $isSupply
                                ? ''
                                : '';
                            $iconClasses = $isSupply
                                ? ''
                        ...
                        <button
                            type="button"
                            class="rounded-3xl border p-6 text-left transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg {{ $cardClasses }}"
                            style="{{ $cardStyle }}"
                            @click="$dispatch('open-product-modal', { productTypeId: '{{ $productType->id }}' }); open = false"
                        >
                            <div class="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full {{ $iconClasses }}" style="{{ $iconStyle }}">
