...
<body>
    ...
    <div class="page">
        ...
        <table class="customer-table">
            ...
            @if($advances->count() > 0)
                <tr>
                    <td class="customer-label">Doc. Relacionado:</td>
        ...
        <div class="totals-wrap">
            <table class="totals-table">
                <tr>
                    ...
                    <td class="totals-value">S/ {{ number_format((float) ($sale->salesMovement?->subtotal ?? 0), 2) }}
                    </td>
                </tr>
                <tr>
                ...
                @if($advances->count() > 0)
                    <tr>
                        <td class="totals-label">Anticipo:</td>
                        <td class="totals-value">-S/ {{ number_format($totalAdvances, 2) }}</td>
                    </tr>
                @endif
                <tr class="grand-total">
                    <td class="totals-label">Importe a Pagar:</td>
