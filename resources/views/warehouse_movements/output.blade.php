                        ...
                        <div class="mb-5 space-y-4">
                            <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                                ...
                                <div class="flex shrink-0 flex-wrap items-center gap-2 sm:gap-3">
                                    ...
                                    <button type="button" id="clear-output-button" class="relative z-10 inline-flex h-12 items-center gap-2 rounded-[22px] border border-rose-200 bg-rose-50 px-5 text-sm font-semibold text-rose-700 hover:bg-rose-100">
