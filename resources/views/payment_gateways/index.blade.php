...
<x-common.component-card title="Listado de pasarela de pago" desc="Gestiona las pasarela de pago registrados en el sistema.">
    ...
    <div class="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-between border-t border-gray-100 pt-6 dark:border-gray-800">
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Mostrando <span class="font-medium text-gray-700 dark:text-gray-200">{{ $paymentGateways->firstItem() ?? 0 }}</span> a <span class="font-medium text-gray-700 dark:text-gray-200">{{ $paymentGateways->lastItem() ?? 0 }}</span> de <span class="font-medium text-gray-700 dark:text-gray-200">{{ $paymentGateways->total() }}</span> registros
        </p>
