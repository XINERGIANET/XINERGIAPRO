...
@section('content')
    <div x-data="{}">
        ...
        <x-common.component-card title="Listado de roles" desc="Gestiona los roles registrados en el sistema.">
            ...
            <div class="overflow-visible mt-4 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <table class="w-full min-w-max">
                    <thead>
                        <tr class="text-white">
                            <th style="background-color: #334155; color: #FFFFFF;" class="px-3 py-3 text-center sm:px-6 first:rounded-tl-xl sticky-left-header">
                            ...
                            <th style="background-color: #334155; color: #FFFFFF; border-top-right-radius: 0.75rem;" class="px-5 py-3 text-center sm:px-6 last:rounded-tr-xl"><p class="font-semibold text-white text-theme-xs">Acciones</p></th>
                        </tr>
                    </thead>
                    <tbody>
                                        ...
                                        @foreach ($rowOperations as $operation)
                                            ...
                                            @if ($isDelete)
                                                <form
                                                    ...
                                                    data-swal-title="Eliminar rol?"
                                                    data-swal-text="Se eliminara {{ $role->name }}. Esta accion no se puede deshacer."
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-12">
                                    <div class="flex flex-col items-center gap-3 text-center text-sm text-gray-500">
                                        ...
                                        <p class="text-base font-semibold text-gray-700 dark:text-gray-200">No hay roles registrados.</p>
                                        <p class="text-gray-500">Crea el primer rol para comenzar.</p>
                                        <x-ui.button size="sm" variant="primary" type="button" @click="$dispatch('open-role-modal')">
            ...
            <div class="p-6 sm:p-8">
                <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Registrar rol</h3>
                            <p class="mt-1 text-sm text-gray-500">Ingresa la informacion del rol.</p>
                        </div>
                    </div>
                    <button
                        type="button"
